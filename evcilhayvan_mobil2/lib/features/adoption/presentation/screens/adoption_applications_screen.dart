...
class AdoptionApplicationsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdoptionApplicationsScreen> createState() =>
      _AdoptionApplicationsScreenState();
}

class _AdoptionApplicationsScreenState
    extends ConsumerState<AdoptionApplicationsScreen>
...
class _InboxTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return inboxAsync.when(
      ...
      error: (e, _) => Center(
        child: Text(
          AppLocalizations.of(context)!.adoptionAppsErrGeneric(e.toString()),
        ),
      ),
      data: (applications) {
        if (applications.isEmpty) {
          ...
          return _emptyState(
            context,
            Icons.inbox,
            l10n.adoptionAppsInboxEmpty,
            l10n.adoptionAppsInboxEmptyDesc,
          );
        }
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => _ApplicationCard(
              ...
              isInbox: true,
              onAccept: () =>
                  _respond(context, ref, applications[index], 'accept'),
              onReject: () =>
                  _respond(context, ref, applications[index], 'reject'),
            ),
          ),
        );
      },
  ...
  Future<void> _respond(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(
          action == 'accept'
              ? l10n.adoptionAppsAcceptTitle
              : l10n.adoptionAppsRejectTitle,
        ),
        content: Text(
          action == 'accept'
        ...
        actions: [
          TextButton(
            ...
            child: Text(l10n.adoptionAppsCancel),
          ),
          TextButton(
            onPressed: () => Navigator.pop(ctx, true),
            child: Text(
              action == 'accept'
                  ? l10n.adoptionAppsAcceptBtn
                  : l10n.adoptionAppsRejectBtn,
              style: TextStyle(
            ...
            RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  ...
                  const TextSpan(
                    text:
                        'Yeni sahiple mesajlaşarak teslim sürecini planlayabilirsin.',
                  ),
                ],
              ),
            ),
      ...
      data: (applications) {
        if (applications.isEmpty) {
          ...
          return _emptyState(
            context,
            Icons.outbox,
            l10n.adoptionAppsSentEmpty,
            l10n.adoptionAppsSentEmptyDesc,
          );
        }
        return RefreshIndicator(
          onRefresh: () async =>
...
class _ApplicationCard extends StatelessWidget {
  ...
  String _getStatusText(BuildContext context) {
    ...
    switch (application.status) {
      case 'ACCEPTED':
        return l10n.adoptionAppsStatusAccepted;
      case 'REJECTED':
        return l10n.adoptionAppsStatusRejected;
      case 'CANCELLED':
        return l10n.adoptionAppsStatusCancelled;
      default:
        return l10n.adoptionAppsStatusPending;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final dateStr = _formatDate(context, application.createdAt);

    final imageUrl = listing != null && listing.images.isNotEmpty
        ? (listing.images.first.startsWith('http')
              ? listing.images.first
              : '$apiBaseUrl${listing.images.first}')
        : null;
        ...
        child: Column(
          children: [
                      ...
                      children: [
                        ...
                        if (isInbox && applicant != null)
                          Text(
                            AppLocalizations.of(
                              context,
                            )!.adoptionAppsApplicant(applicant.name),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(
                          AppLocalizations.of(context)!.adoptionAppsRejectBtn,
                        ),
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: Text(
                          AppLocalizations.of(context)!.adoptionAppsAcceptBtn,
                        ),
            ...
            if (application.status == 'ACCEPTED' &&
                application.conversationId != null)
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 12),
                child: SizedBox(
                  width: double.infinity,
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      AppLocalizations.of(context)!.adoptionAppsGoToChat,
                    ),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF2D6A4F),
                      foregroundColor: Colors.white,
      ...
      child: Row(
        children: [
          for (int i = 0; i < steps.length; i++) ...[
            _TimelineStep(label: steps[i].$1, state: steps[i].$2),
            if (i < steps.length - 1)
              Expanded(
                child: Container(
                  height: 2,
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 9,
            color: state == _StepState.inactive
